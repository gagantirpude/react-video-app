...
const Videos = () => {
  ...
  //todo: useState for video
  const [video, setVideo] = useState(videosArr[0]);

  return (
    <Stack direction={['column', 'row']} h={['100%', 'auto']}>
      <VStack w={'full'}>
        <video
          controls
        ...
        ></video>
        {/*  */}
        <VStack alignItems={'flex-start'} p={'8'} w={'100%'} overflowY={'auto'}>
          <Heading> Sample Video 1</Heading>
          <Text> This a Sample Video for testing and Demo</Text>
        </VStack>
      </VStack>
      {/*  */}
      <VStack
